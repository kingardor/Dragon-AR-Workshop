...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    {
        private static GameObject s_LastSpawnedObject;
        ...
        public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
        {
            ...
            if (s_LastSpawnedObject != null) {
                Destroy(s_LastSpawnedObject);
            }
            s_LastSpawnedObject = newObject;
        ...
        {
            // Destroy all other dragons spawned by us
            foreach(var oldDragon in GameObject.FindGameObjectsWithTag("Player")) {
                if (oldDragon.name.Contains("DragonPrefab")) Destroy(oldDragon);
            }
